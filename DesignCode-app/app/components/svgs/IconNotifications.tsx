...
function SvgIconNotifications({ color, ...otherProps }: React.SVGProps<SVGSVGElement>) {
  return (
    <Svg width={24} height={24} {...otherProps}>
      <G clipPath="url(#icon-notifications_svg__clip0)" fill={color}>
      ...
      <Defs>
        <ClipPath id="icon-notifications_svg__clip0">
